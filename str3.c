...
/**
 * get_int - get char pointer to new str with integer
 * @num: The number converted to string
 * Done by: Mekonen Abera & Gebrekidan Alemayehu
 * Return: char pointer converted
 *       : null if fails and malloc
 */
...
/**
 * len_buff_uint - length of buffer for an unsigned int
 * @num: number to get length needed
 * @base: base of number representation used by buffer
 * Done by: Mekonen Abera & Gebrekidan Alemayehu
 * Return: int of length of buffer
 */
...
/**
 * full_buff - complete buffer with numbers
