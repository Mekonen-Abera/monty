...
/**
 * globales_s - struct with global variables
 * @token2: integer numbers
 * @fd: points to the previous stack or queue elements
 * @line_buf: points to the next stack or queue elements
